...
if __name__ == '__main__':
    test_set = np.array([[33.55, 18.26, 5.97, 18.38, 18.88], [7.14, 6.9, 47.51, 22.6, 48.95],
                         [19.72, 49.73, 14.06, 42.94,
                          0.94], [37.61, 38.57, 45.55, 7.3, 36.8], [2.47, 33.43, 47.14, 0.66, 9.06],
                         [47.61, 48.25, 21.95, 38.62, 23.92], [8.27, 41.05, 30.81, 1.47, 44.42], [
                             30.91, 25.42, 49.32, 14.81, 37.49
                         ], [21.81, 19.36, 45.95, 15.43, 13.9], [48.08, 7.2, 39.42, 27.94, 35.45]])

    print([(4, 9), (1, 2), (0, 7), (4, 5), (2, 6)])
    print(buy_sell(test_set))

    test_set = np.array([[26.97, 2.89, 15.82, 13.5, 17.75], [10.42, 0.07, 21.98, 46.04, 6.54], [
        19.82, 1.55, 8.19, 43.97, 5.36
    ], [30.41, 1.26, 33.15, 25.96, 2.31], [16.75, 48.23, 0.4, 9.28, 32.68], [
        17.45, 34.79, 23.59, 24.15, 48.04
    ], [10.34, 45.48, 37.39, 23.35, 26.31], [2.25, 8.94, 4.92, 6.42, 16.52],
                         [40.89, 40.36, 43.07, 33.94, 13.56], [22.92, 6.37, 11.89, 38.31, 10.16]])
